                ...
                ->arrayNode('gateway')
                    ...
                    ->children()
                        ->arrayNode('bag')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Gateway\Bag\GatewayBag')->end()
                            ->end()
                        ->end()
                        ->arrayNode('message')
                            ->addDefaultsIfNotSet()
                ...
                ->arrayNode('manager')
                    ...
                    ->children()
                        ->arrayNode('bag')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Manager\Bag\ManagerBag')->end()
                            ->end()
                        ->end()
                        ->arrayNode('message')
                            ->addDefaultsIfNotSet()
