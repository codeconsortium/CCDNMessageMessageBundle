                ...
                ->arrayNode('repository')
                    ...
                    ->children()
                        ->arrayNode('folder')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Repository\FolderRepository')->end()
                            ->end()
                        ->end()
                        ->arrayNode('envelope')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Repository\EnvelopeRepository')->end()
                            ->end()
                        ->end()
                        ->arrayNode('message')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Repository\MessageRepository')->end()
                            ->end()
                        ->end()
                        ->arrayNode('registry')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Repository\RegistryRepository')->end()
                            ->end()
                        ->end()
                        ->arrayNode('thread')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Repository\ThreadRepository')->end()
                            ->end()
                        ->end()
                        ->arrayNode('user')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Repository\UserRepository')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('gateway')
                    ...
                    ->children()
                        ->arrayNode('folder')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Gateway\FolderGateway')->end()
                            ->end()
                        ->end()
                        ->arrayNode('envelope')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Gateway\EnvelopeGateway')->end()
                            ->end()
                        ->end()
                        ->arrayNode('message')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Gateway\MessageGateway')->end()
                            ->end()
                        ->end()
                        ->arrayNode('thread')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Gateway\ThreadGateway')->end()
                            ->end()
                        ->end()
                        ->arrayNode('registry')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Gateway\RegistryGateway')->end()
                            ->end()
                        ->end()
                        ->arrayNode('user')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Gateway\UserGateway')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('manager')
                    ...
                    ->children()
                        ->arrayNode('folder')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Manager\FolderManager')->end()
                            ->end()
                        ->end()
                        ->arrayNode('envelope')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Manager\EnvelopeManager')->end()
                            ->end()
                        ->end()
                        ->arrayNode('message')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Manager\MessageManager')->end()
                            ->end()
                        ->end()
                        ->arrayNode('thread')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Manager\ThreadManager')->end()
                            ->end()
                        ->end()
                        ->arrayNode('registry')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Manager\RegistryManager')->end()
                            ->end()
                        ->end()
                        ->arrayNode('user')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\Component\Manager\UserManager')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ...
                ->arrayNode('model')
                    ...
                    ->children()
                        ->arrayNode('folder')
                            ...
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\FrontModel\FolderModel')->end()
                            ->end()
                        ->end()
                        ->arrayNode('envelope')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\FrontModel\EnvelopeModel')->end()
                            ->end()
                        ->end()
                        ->arrayNode('message')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\FrontModel\MessageModel')->end()
                            ->end()
                        ->end()
                        ->arrayNode('thread')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\FrontModel\ThreadModel')->end()
                            ->end()
                        ->end()
                        ->arrayNode('registry')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\FrontModel\RegistryModel')->end()
                            ->end()
                        ->end()
                        ->arrayNode('user')
                            ->addDefaultsIfNotSet()
                            ->canBeUnset()
                            ->children()
                                ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Model\FrontModel\UserModel')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                        ...
                        ->arrayNode('twig_extension')
                            ...
                            ->children()
                                ->arrayNode('registry')
                                    ...
                                    ->canBeUnset()
                                    ->children()
                                        ->scalarNode('class')->defaultValue('CCDNMessage\MessageBundle\Component\TwigExtension\RegistryExtension')->end()
                                    ->end()
                                ->end()
